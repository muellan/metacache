...
#ifndef MC_STATISTICS_COMBINED_HPP_
#define MC_STATISTICS_COMBINED_HPP_


#include "stat_moments.hpp"
...
public:
    ...
    statistics_accumulator (const statistics_accumulator&) = default;
    ...
    //---------------------------------------------------------------
    void merge (const statistics_accumulator& other) {
